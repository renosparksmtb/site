const JoinSection = () => (
  <section id="join" className="section-padding bg-forest-light">
    <div className="container-narrow">
      ...
      <div className="mb-16">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="space-y-4 text-foreground/90 leading-relaxed">
            ...
            <h3 className="pt-2 text-lg font-semibold text-secondary">How to Get Started</h3>
          ...
          <div className="flex flex-col items-start justify-center gap-4">
            ...
            <a
              href="#"
              className="inline-flex rounded-lg border-2 border-secondary px-8 py-3.5 text-base font-semibold text-secondary transition-colors hover:bg-secondary hover:text-secondary-foreground"
            >
      ...
      <div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          <div className="rounded-xl border-2 border-accent bg-card p-6 shadow-sm">
            <p className="text-sm font-semibold text-accent">Early Bird</p>
          ...
          <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
            <p className="text-sm font-semibold text-secondary">Standard</p>
          ...
          <div className="flex flex-col justify-center rounded-xl border border-border bg-card p-6 shadow-sm sm:col-span-2 lg:col-span-1">
            <p className="text-sm font-semibold text-secondary">Included</p>
